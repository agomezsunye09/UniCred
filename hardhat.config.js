...
module.exports = {
    networks: {
        ...
        ethereum: {
            url: "https://mainnet.infura.io/v3/ef788e3273ca47ea9a479ee7939a6eb1",
            accounts: [process.env.PRIVATEKEY, process.env.PRIVATEKEY1],
        },
        goerli: {
            url: "https://goerli.infura.io/v3/ef788e3273ca47ea9a479ee7939a6eb1",
            accounts: [process.env.PRIVATEKEY, process.env.PRIVATEKEY1],
        },
        bsc: {
    ...
    etherscan: {
        ...
        apiKey: "XF74TBYV4CQS3XKFAK94JSQJ8H1B6SVCR8",
    },
    solidity: {
        compilers: [
            {
